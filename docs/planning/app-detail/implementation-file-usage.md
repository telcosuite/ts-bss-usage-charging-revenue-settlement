# Usage, Charging, And Revenue Settlement Implementation File Usage

Reviewed: 2026-06-14

## Purpose

Use this guide when building `Usage, Charging, And Revenue Settlement`. It explains which generated files matter, when to read them, and how they drive Angular, Spring Boot, PostgreSQL, TMF API, event, and privacy work.
...
| App overview | [../usage-charging-revenue-settlement.md](../usage-charging-revenue-settlement.md) | Concise product scope, app purpose, TMF API usage, ownership, integrations, and first-release direction. |
...
| App TMF review | [../../tmf-api-ddl-reviews/usage-revenue-settlement.md](../../tmf-api-ddl-reviews/usage-revenue-settlement.md) | TMF APIs, resource-to-table mapping, field handling, event baseline, privacy/retention/audit baseline. |
...
| App V002+ migration | [../../../../database/postgres/suites/ts_bss_commercial/V006__refine_usage_revenue_settlement_tmf_core.sql](../../../../database/postgres/suites/ts_bss_commercial/V006__refine_usage_revenue_settlement_tmf_core.sql) | Promotes common TMF columns and creates app support tables, event_contract, and privacy_retention_policy. |
...
9. Use `usage_revenue_settlement.event_contract` as the baseline event register and `usage_revenue_settlement.event_outbox` for publication.
10. Use `usage_revenue_settlement.privacy_retention_policy` as the baseline for masking, audit, retention, legal hold, and residency handling.
...
- Write only inside schema `usage_revenue_settlement` for this app's operational data.
